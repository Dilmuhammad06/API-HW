...
Uzbekistan,Kazakstan,Russia,America,Korea = ('uzbekistan','kazakstan','russia','america','korea')
...
class User(BaseModel,AbstractUser):
    ...
    county_code = models.CharField(max_length=255,choices=COUNTRIES, null=True, blank=True)
